...
# TODO: import from rdt
MAX_DECIMALS = 100_000_000
...
def patch_float_formatter_rounding_bug():
    ...
    orig_rounding_digits = FloatFormatter._rounding_digits
    try:
        FloatFormatter._reverse_transform = _patched_float_formatter_reverse_transform
        FloatFormatter._rounding_digits = staticmethod(
            _patched_float_formatter_rounding_digits
        )
        yield
    finally:
        FloatFormatter._rounding_digits = staticmethod(orig_rounding_digits)
...
def _patched_float_formatter_rounding_digits(data):
